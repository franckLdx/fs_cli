...
export { Logger, LogRecord } from "https://deno.land/std@0.93.0/log/logger.ts";

export { BaseHandler } from "https://deno.land/std@0.93.0/log/handlers.ts";

export { getLevelByName } from "https://deno.land/std@0.93.0/log/levels.ts";
