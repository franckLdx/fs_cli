export { assert } from "https://deno.land/std@0.82.0/testing/asserts.ts";
...
} from "https://deno.land/std@0.82.0/log/mod.ts";
export { Logger, LogRecord } from "https://deno.land/std@0.82.0/log/logger.ts";

export { BaseHandler } from "https://deno.land/std@0.82.0/log/handlers.ts";
